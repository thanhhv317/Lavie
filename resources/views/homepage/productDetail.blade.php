	...
	<div class="row mt-5">
		...
		<div class="col-md-9 col-sm-12 col-12">
			...
			<div class="mt-3 container">
				<div class="fb-share-button" data-href="{{ url('products/') . '/' .$product['slug'] . '/'. $product['product_id'] }}" data-layout="button_count" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Chia sẻ</a></div>
				<hr>
				<h2>Description:</h2>
				<p>
					{{ $product['description'] }}
